...
$(window).on('load', function() {
  ...
  return delay(300, function() {
    ...
    getNumberSequenceTrials = function(seqLength, numTrials) {
      var i, j, k, l, ref, ref1, sequence, trialObj, trials;
      trials = [];
      for (i = k = 0, ref = numTrials; (0 <= ref ? k < ref : k > ref); i = 0 <= ref ? ++k : --k) {
        sequence = [];
        trialObj = {};
...
`;
  ...
  task_memory["final_quiz"] = {
    on_start: function() {
      ...
      SCORE = console.log(numCorrectSequences);
      console.log(numCorrectSequences * 100);
      console.log(numCorrectSequences * 100 / NUM_TRIALS);
      return console.log(Math.round(numCorrectSequences * 100 / NUM_TRIALS));
    },
    preamble: function() {
      return `<h1>Quiz</h1>
...
Move with the arrow keys after you are done clicking.`,
      ...
      "") === jsPsych.timelineVariable("correct_sequence")) {
            ...
            return console.log("Correct sequence:" + numCorrectSequences);
          } else {
