...
var BASE_COST, BLOCKS, BONUS, BONUS_RATE, CLICK_COST_FNS, CLICK_DELAY_FNS, CLICK_DEPTHS, CLICK_TIME_ANSWERS, CLICK_TIME_CORRECT, CONDITION, CORRECT_SEQ_PCTG, COST, COST_ANSWERS, COST_ANSWERS_BASELINE, COST_CORRECT, COST_CORRECT_BASELINE, COST_EXPLANATION, COST_QUESTION, COST_QUESTION_BASELINE, DEBUG, DEBUG_SHOW_INSTRUCTIONS, DEBUG_SUBMIT, INSTRUCTIONS_FAILED, MAX_AMOUNT, MAX_REPETITIONS, NUM_SEQUENCE_LENGTH, NUM_TRIALS, NUM_TUTORIAL_TRIALS, N_TRIAL, PARAMS, PRACTICE_TIME_NEXT_CLICK, QUESTIONNAIRES, REPETITIONS, SCORE, STRUCTURE, TALK, TIME_NEXT_CLICK, TIME_NODE_REVEAL, TRIALS, bonus_text, calculateBonus, colorInterpolation, condition, createQuestionnaires, createStartButton, early_nodes, final_nodes, getClickCosts, getColor, getCost, getNumberSequenceTrials, getPracticeTrials, getStroopTrials, getTrials, initializeExperiment, jsPsych, numCorrectSequences, pracTrialCount, psiturk, saveData, trialCount,
  indexOf = [].indexOf;
...
initializeExperiment = function() {
  var demographics, experiment_timeline, finish, finish_fail, fullscreen, if_node1, mdp_trials, minimumTime, prompt_resubmit, ready_screen, reprompt, save_data, secret_code_trial, self_report, self_report_2, task_control, task_misaligned;
  $('#jspsych-target').html('');
  //  ============================== #
  //  ========= EXPERIMENT ========= #
  //  ============================== #
